...
\hyperlink{interface_fuse_s_d_k_a279e4cb8e95a3e78197761156a7de50d}{+ display\+Notifications (\+Fuse\+S\+D\+K)} for more information on displaying in-\/game notifications 
\end{DoxySeeAlso}
\hypertarget{protocol_fuse_delegate-p_a95df901f497b5a80383dd6eb2aa9c43d}{}\index{Fuse\+Delegate-\/p@{Fuse\+Delegate-\/p}!on\+Ad\+Clicked\+With\+Message\+:@{on\+Ad\+Clicked\+With\+Message\+:}}
\index{on\+Ad\+Clicked\+With\+Message\+:@{on\+Ad\+Clicked\+With\+Message\+:}!Fuse\+Delegate-\/p@{Fuse\+Delegate-\/p}}
\subsubsection[{on\+Ad\+Clicked\+With\+Message\+:}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (void) on\+Ad\+Clicked\+With\+Message\+: 
\begin{DoxyParamCaption}
\item[{(N\+S\+String $\ast$)}]{\+\_\+message}
\end{DoxyParamCaption}
\hspace{0.3cm}{\ttfamily [optional]}}\label{protocol_fuse_delegate-p_a95df901f497b5a80383dd6eb2aa9c43d}


Callback to acknowledge an News Ad was clicked and the app should react to \+\_\+message. 


\begin{DoxyParams}{Parameters}
{\em \+\_\+message} & Dashboard set token for the application to respond to. Ex. 'open\+Store'\\
\hline
\end{DoxyParams}
...
\{
   \textcolor{keywordflow}{if}([\_message isEqualToString:\textcolor{stringliteral}{@"openStore"}])
   \{
       [game OpenCoinStore];
   \}
