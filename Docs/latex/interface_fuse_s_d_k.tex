...
\begin{DoxyCode}
NSArray* adZoneList = [[\hyperlink{interface_fuse_s_d_k}{FuseSDK} \textcolor{keyword}{get}] \hyperlink{interface_fuse_s_d_k_aa268a44dea0b4db37d2d4ffa2c0ed23d}{GetAdZoneList}]
\end{DoxyCode}
...
\hyperlink{interface_fuse_s_d_k_adf7ed64a02b9540c9ded4b931ea4e400}{+ start\+Session\+:delegate\+:with\+Options\+:} for information on setting up the $<$\hyperlink{protocol_fuse_delegate-p}{Fuse\+Delegate}$>$ 
\end{DoxySeeAlso}
\hypertarget{interface_fuse_s_d_k_a3314236b84929bbc6fb400ac72135691}{}\index{Fuse\+S\+D\+K@{Fuse\+S\+D\+K}!get\+I\+A\+P\+Offer\+Info\+For\+Zone\+I\+D\+:@{get\+I\+A\+P\+Offer\+Info\+For\+Zone\+I\+D\+:}}
\index{get\+I\+A\+P\+Offer\+Info\+For\+Zone\+I\+D\+:@{get\+I\+A\+P\+Offer\+Info\+For\+Zone\+I\+D\+:}!Fuse\+S\+D\+K@{Fuse\+S\+D\+K}}
\subsubsection[{get\+I\+A\+P\+Offer\+Info\+For\+Zone\+I\+D\+:}]{\setlength{\rightskip}{0pt plus 5cm}+ ({\bf Fuse\+I\+A\+P\+Offer\+Object}$\ast$) get\+I\+A\+P\+Offer\+Info\+For\+Zone\+I\+D\+: 
\begin{DoxyParamCaption}
\item[{(N\+S\+String $\ast$)}]{\+\_\+zone\+I\+D}
\end{DoxyParamCaption}
}\label{interface_fuse_s_d_k_a3314236b84929bbc6fb400ac72135691}


This Method returns the \hyperlink{interface_fuse_i_a_p_offer_object}{Fuse\+I\+A\+P\+Offer\+Object} for a given zone\+I\+D, or nil if there is no I\+A\+P offer available. 

If a zone currently contains a I\+A\+P offer, that information will be passed back.


\begin{DoxyCode}
\hyperlink{interface_fuse_i_a_p_offer_object}{FuseIAPOfferObject} * zoneReward = [\hyperlink{interface_fuse_s_d_k}{FuseSDK} getIAPOfferInfoForZoneID:\textcolor{stringliteral}{@"zoneID"}];
\end{DoxyCode}
...
a \hyperlink{interface_fuse_i_a_p_offer_object}{Fuse\+I\+A\+P\+Offer\+Object} with the offer information 
\end{DoxyReturn}
\begin{DoxySince}{Since}
Fuse S\+D\+K version 2.\+2.\+0 
\end{DoxySince}
...
This Method returns the \hyperlink{interface_fuse_rewarded_object}{Fuse\+Rewarded\+Object} for a given zone\+I\+D, or nil if there is no rewards available. 
...
Fuse S\+D\+K version 2.\+0.\+0 
\end{DoxySince}
\hypertarget{interface_fuse_s_d_k_a2988bfb2515b70af4aeafd4dea7ada57}{}\index{Fuse\+S\+D\+K@{Fuse\+S\+D\+K}!get\+Virtual\+Goods\+Offer\+Info\+For\+Zone\+I\+D\+:@{get\+Virtual\+Goods\+Offer\+Info\+For\+Zone\+I\+D\+:}}
\index{get\+Virtual\+Goods\+Offer\+Info\+For\+Zone\+I\+D\+:@{get\+Virtual\+Goods\+Offer\+Info\+For\+Zone\+I\+D\+:}!Fuse\+S\+D\+K@{Fuse\+S\+D\+K}}
\subsubsection[{get\+Virtual\+Goods\+Offer\+Info\+For\+Zone\+I\+D\+:}]{\setlength{\rightskip}{0pt plus 5cm}+ ({\bf Fuse\+Virtual\+Goods\+Offer\+Object}$\ast$) get\+Virtual\+Goods\+Offer\+Info\+For\+Zone\+I\+D\+: 
\begin{DoxyParamCaption}
\item[{(N\+S\+String $\ast$)}]{\+\_\+zone\+I\+D}
\end{DoxyParamCaption}
}\label{interface_fuse_s_d_k_a2988bfb2515b70af4aeafd4dea7ada57}


This Method returns the \hyperlink{interface_fuse_rewarded_object}{Fuse\+Rewarded\+Object} for a give zone\+I\+D, or nil if there is Virtual Good offer available. 

If a zone currently contains a Virtual Goods offer, that information will be passed back.


\begin{DoxyCode}
\hyperlink{interface_fuse_virtual_goods_offer_object}{FuseVirtualGoodsOfferObject} * zoneReward = [\hyperlink{interface_fuse_s_d_k}{FuseSDK} 
      getVirtualGoodsOfferInfoForZoneID:\textcolor{stringliteral}{@"zoneID"}];
\end{DoxyCode}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
a \hyperlink{interface_fuse_virtual_goods_offer_object}{Fuse\+Virtual\+Goods\+Offer\+Object} with the offer information 
\end{DoxyReturn}
\begin{DoxySince}{Since}
Fuse S\+D\+K version 2.\+2.\+0 
\end{DoxySince}
...
\hline
\end{DoxyParams}
\hypertarget{interface_fuse_s_d_k_a61579033e1c61be4ee4567c4ed159dd0}{}\index{Fuse\+S\+D\+K@{Fuse\+S\+D\+K}!set\+Rewarded\+Video\+User\+I\+D\+:@{set\+Rewarded\+Video\+User\+I\+D\+:}}
\index{set\+Rewarded\+Video\+User\+I\+D\+:@{set\+Rewarded\+Video\+User\+I\+D\+:}!Fuse\+S\+D\+K@{Fuse\+S\+D\+K}}
\subsubsection[{set\+Rewarded\+Video\+User\+I\+D\+:}]{\setlength{\rightskip}{0pt plus 5cm}+ (void) set\+Rewarded\+Video\+User\+I\+D\+: 
\begin{DoxyParamCaption}
\item[{(N\+S\+String $\ast$)}]{\+\_\+user\+I\+D}
\end{DoxyParamCaption}
}\label{interface_fuse_s_d_k_a61579033e1c61be4ee4567c4ed159dd0}


This method sets the user I\+D string for rewarded video server verification. 

To allow server side verificiation. A user id registered with this function is passed to the server when a rewarded video has been completed. The server then transmits this id to the 3rd Party server registered on the Fuse\+Powered Dashboard. The value is only cached for the duration of the session, and can be changed at any time.


\begin{DoxyParams}{Parameters}
{\em \+\_\+user\+I\+D} & \mbox{[}N\+S\+String $\ast$\mbox{]} String username to use for Rewarded verification, May be N\+U\+L\+L 
\begin{DoxyCode}
[\hyperlink{interface_fuse_s_d_k}{FuseSDK} setRewardedVideoUserID:\textcolor{stringliteral}{@"bobSmith1994"}];
\end{DoxyCode}
 \\
\hline
\end{DoxyParams}
