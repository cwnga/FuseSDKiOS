...
Pod::Spec.new do |s|
  ...
  s.ios.framework  = "Accelerate", "AdSupport", "AudioToolbox", "AVFoundation", "CoreGraphics", "CoreLocation", "CoreMedia", "CoreTelephony", "EventKit", "EventKitUI", "Foundation", "GameKit", "iAd", "MediaPlayer", "MessageUI", "MobileCoreServices", "QuartzCore", "StoreKit", "SystemConfiguration", "Twitter", "UIKit", "WebKit"
  s.ios.weak_framework = "Social"
  s.ios.library = "sqlite3", "xml2", "z"
